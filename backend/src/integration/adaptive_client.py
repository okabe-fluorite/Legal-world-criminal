...
def build_adaptive_event(event: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "case_bundle_id": _text(event.get("case_bundle_id")),
        "case_bundle_version": _text(event.get("case_bundle_version")),
        "case_bundle_content_sha256": _text(event.get("case_bundle_content_sha256")),
        "law_corpus_manifest_sha256": _text(event.get("law_corpus_manifest_sha256")),
        "rubric_version": _text(event.get("rubric_version")),
