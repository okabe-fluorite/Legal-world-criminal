...
MODEL_ENV_KEYS = {
    ...
    "SIMLAW_MODEL_LEARNING_SUPPORT_NAME",
    "SIMLAW_MODEL_LEARNING_SUPPORT_API_BASE_URL",
    "SIMLAW_MODEL_LEARNING_SUPPORT_API_KEY",
    "SIMLAW_MODEL_LEARNING_SUPPORT_TIMEOUT_SECONDS",
