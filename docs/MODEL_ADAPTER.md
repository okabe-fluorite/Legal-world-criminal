...
| `subjective_scoring` | 主观短答/角色互换的Rubric形成性反馈；始终受教师门禁 |
...
SIMLAW_SMALL_MODEL_TASKS=teaching_judge,citation_alignment,response_assist,learning_support,subjective_scoring
